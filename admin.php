        ...
        <div class="modal-content">
            ...
            <form id="emailForm">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="emailSubject" class="admin-input" placeholder="Enter email subject" >
                </div>
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Message</label>
                    <textarea id="emailMessage" class="admin-input" rows="6" placeholder="Enter your message" ></textarea>
                </div>
            ...
            <form id="roomForm">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="mb-3">
                        ...
                        <select id="roomType" class="admin-input" >
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="roomName" class="admin-input" placeholder="e.g., Deluxe Room" >
                    </div>
                    <div class="mb-3">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Price (KSh)</label>
                        <input type="number" id="roomPrice" class="admin-input" placeholder="35000" >
                    </div>
                    <div class="mb-3">
                ...
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Room Images (6 images )</label>
            ...
            <form id="amenityForm">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="mb-3">
                        ...
                        <div class="flex gap-2">
                            <select id="amenityCategory" class="admin-input flex-1" >
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="amenityName" class="admin-input" placeholder="e.g., The Sanctuary Spa" >
                    </div>
                    <div class="mb-3">
        ...
        <div class="modal-content" style="max-width: 500px;">
            ...
            <form id="roomTypeForm">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="roomTypeName" class="admin-input" placeholder="e.g., Deluxe Suite" >
                </div>
                <div class="mb-3">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Description</label>
        ...
        <div class="modal-content" style="max-width: 500px;">
            ...
            <form id="amenityCategoryForm">
                <div class="mb-3">
                    ...
                    <input type="text" id="amenityCategoryName" class="admin-input" placeholder="e.g., Leisure" >
                </div>
                <div class="mb-3">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Description</label>
            ...
            <form id="eventVenueForm">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="mb-3 col-span-2">
                        ...
                        <input type="text" id="eventVenueName" class="admin-input" placeholder="e.g., Grand Ballroom" >
                    </div>
                    <div class="mb-3">
        ...
        <div class="modal-content" style="max-width: 600px;">
            ...
            <form id="liveEventForm">
                ...
                <div class="mb-4">
                    ...
                    <textarea id="liveEventDescription" class="admin-input" rows="3" placeholder="Enter event description" ></textarea>
                </div>
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Event Date</label>
                    <input type="date" id="liveEventDate" class="admin-input" >
                </div>
                <div class="mb-4">
        ...
        <div class="modal-content" style="max-width: 500px;">
            ...
            <form id="galleryAlbumForm">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="galleryAlbumTitle" class="admin-input" placeholder="e.g., Our Rooms" >
                </div>
                <div class="mb-3">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Description</label>
        ...
        <div class="modal-content" style="max-width: 500px;">
            ...
            <form id="galleryImageForm">
                ...
                <div class="mb-3">
                    ...
                    <select id="galleryImageAlbum" class="admin-input" >
        ...
        <div class="modal-content" style="max-width: 500px;">
            ...
            <form id="galleryVideoForm">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="galleryVideoTitle" class="admin-input" placeholder="Video title" >
                </div>
                <div class="mb-3">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Description</label>
            ...
            <form id="offerForm">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="mb-3">
                        ...
                        <input type="text" id="offerTitle" class="admin-input" placeholder="e.g., Summer Getaway" >
                    </div>
                    <div class="mb-3">
            ...
            <form id="menuItemForm" novalidate>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="mb-3">
                        ...
                        <input type="text" id="menuItemName" class="admin-input" placeholder="e.g., Grilled Salmon" >
                    </div>
                    <div class="mb-3">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Category</label>
                        <select id="menuItemCategory" class="admin-input" >
                            <option value="">Select Category</option>
                        </select>
                    </div>
                    <div class="mb-3">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Price (KSh)</label>
                        <input type="number" id="menuItemPrice" class="admin-input" placeholder="2500" >
                    </div>
                    <div class="mb-3">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Display Order</label>
        ...
        <div class="modal-content" style="max-width: 500px;">
            ...
            <form id="sampleMenuForm">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="sampleMenuTitle" class="admin-input" placeholder="e.g., Chef's Special Tasting Menu" >
                </div>
                <div class="mb-3">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Description</label>
            ...
            <form id="sampleMenuItemForm" class="mb-4 p-4 bg-gray-50 rounded-lg">
                ...
                <div class="grid grid-cols-2 gap-3 mb-3">
                    <div>
                        ...
                        <input type="text" id="sampleMenuItemName" class="admin-input" placeholder="e.g., Grilled Salmon" >
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Price (KSh)</label>
                        <input type="number" id="sampleMenuItemPrice" class="admin-input" placeholder="2500" >
                    </div>
                </div>
                <div class="mb-3">
            ...
            <form id="tableTypeForm">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="mb-3">
                        ...
                        <input type="text" id="tableTypeName" class="admin-input" placeholder="e.g., Private Candlelight Dinner" >
                    </div>
                    <div class="mb-3">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Max Guests</label>
                        <input type="number" id="tableTypeMaxPeople" class="admin-input" placeholder="2" >
                    </div>
                    <div class="mb-3">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Price (KSh)</label>
...
document.getElementById('liveEventForm').addEventListener('submit', function(e) {
    ...
    .finally(() => {
        ...
        function loadAmenitiesForRoom(selectedAmenities = []) {
            const formData = new FormData();
                ...
                if (data.success) {
                    ...
                    container.innerHTML = data.amenities.map(amenity => `
                        <label class="flex items-center gap-2 cursor-pointer hover:bg-gray-50 p-2 rounded">
                            <input type="checkbox" name="roomAmenities" value="${amenity.name}" class="w-4 h-4 rounded accent-[#b89a78]" ${selectedAmenities.includes(amenity.name) ? 'checked' : ''}>
        ...
        function openRoomModal(room = null) {
            ...
            if (room) {
                ...
                // Load amenities with no selection
